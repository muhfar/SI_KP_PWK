                                     ...
                                     foreach ($query->result() as $row) {
                                        ...
                                        ?>
                                            <button type="button" class="btn btn-icon" data-toggle="modal" data-target="#daftarModal" id="edit" data-aksi="edit"
                                                data-NIM="<?=$row->NIM?>" data-nama="<?=$row->nama_depan.$row->nama_belakang?>" data-instansi_nama="<?=$row->instansi_nama?>" data-instansi_alamat="<?=$row->instansi_alamat?>" data-instansi_mulai="<?=$row->instansi_mulai?>"
                                                    data-instansi_selesai="<?=$row->instansi_selesai?>"
                                            >
                                                <span class='fas fa-pencil-alt'></span>
                                            </button>
                                            <a class="btn btn-danger" href="<?php echo site_url('admin/c_admin_jadwal/delete/'. $row->id_nim); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data id=<?=$row->id_nim;?> ?');">
